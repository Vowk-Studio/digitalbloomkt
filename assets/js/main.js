...
function initEffects() {
    ...
    function renderPackDetail(serviceId, packIndex) {
        ...
        modalBodyInject.innerHTML = `
            ...
            <a href="https://wa.me/+5492213576210?text=${encodeURIComponent(pack.wspMessage)}" target="_blank" rel="noopener noreferrer" class="btn-shine-gold w-100" style="display: block; margin-top: 30px;">Quiero mi pack <i class="fab fa-whatsapp" style="margin-left: 8px;"></i></a>
        `;
